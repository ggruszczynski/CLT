...
% Given that matlab is very bad at handling loops it is better to avoid them altogether if possible. 
% I adjusted your code by removing the sub-function completely, "global" attributes for N and ybar (lines 46 and 48) and substituting loop in lines 52-54 by
